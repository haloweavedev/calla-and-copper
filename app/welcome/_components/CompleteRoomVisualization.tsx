...
export function CompleteRoomVisualization({ products }: CompleteRoomVisualizationProps) {
  ...
  const handleGenerateRoom = useCallback(async () => {
    ...
    try {
      ...
      console.log('[CLIENT] Generated image URL type:', typeof imageUrl)
      console.log('[CLIENT] Generated image URL length:', imageUrl?.length)
      console.log('[CLIENT] Generated image URL starts with data:', imageUrl?.startsWith('data:'))
